...
import com.codegym.customer_management.service.ProvinceService;
...
public class CustomerController {
    ...
    @GetMapping
    public ModelAndView showList(Optional<String> s,@PageableDefault(value = 1) Pageable pageInfo) throws Exception {
