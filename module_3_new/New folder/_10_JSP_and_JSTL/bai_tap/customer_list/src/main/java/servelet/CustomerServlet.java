...
public class CustomerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        customerList.add(new Customer("Mai Văn Hàn", "1983-08-20", "Hà Nội","anh-dai-dien-2.jpg" ));
        customerList.add(new Customer("Nguyễn Văn Nam", "1983-08-21", "Bắc Giang", "anh-dai-dien-1.jpg" ));
